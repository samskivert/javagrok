...
others provide textual results for which JavaGrok reads in the result. %TODO: I am still unhappy with this text.
...
annotations. These then get extracted into files in the JAI format with the
help of the annotations file utilities AFU~\cite{AFU}.

Analog to the retention and uniqueness annotations the exception analysis is 
integrated into the Java 7 compiler too. As before JavaGrok extracts these
annotations from the augmented class files using the AFU.
