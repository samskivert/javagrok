...
inference analysis.  Both of these tools make closed world assumptions, but the Ekman and Hedin's JastAdd inferencer does not require a whole program analysis---hence our decision to use it.  (Further details on further nullability analysis tools and discussion should be here in the final version.  Didn't have time right now to get to it.)
