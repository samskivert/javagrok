...
that the new presentation of documentation helped developers.  Any of these
...
They do not use their alias annotations for documentation purposes.  Their
annotations must also be sound for type-checking. In their evaluation
they mainly show how much time they needed to annotate the source code by hand.
They implement inference for their annotations, but found the inference to
produce too much information to be useful for developers (the results were too
precise).
