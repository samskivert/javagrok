...
% TODO: Already motivated in example....
%Uniqueness information on returned objects poses similar useful scenarios. As
%already motivated with the example in section~\ref{sec:Example} uniqueness 
%information of return values can be critical in situations where the developer 
%might not expect a method to leak it's internal representation. 
...
As in Buse and Weimer's work~\cite{autodoc}, we expose internal field names and
