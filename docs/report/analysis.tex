...
Foster~\cite{Uno}. It infers alias and encapsulation properties for Java.  
These properties provide information about how a certain
...
called method to which the object was passed as an argument. 
This property of uniqueness preserving is called lent parameter. Analogously to 
...
Also see the example in section~\ref{sec:Example}.
