...
intraprocedural points-to analysis combined with a interprocedural analysis.
...
Below we enumarete the annotations JavaGrok infers.

\texttt{@UniqueReturn} can appear on method declarations. This annotations 
...
a reference to the referent in a field.
